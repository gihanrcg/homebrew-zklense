class Zklense < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/jinali98/zk-lense/releases/download/v0.1.2/zklense-x86_64-apple-darwin.tar.gz"
      sha256 "sha256:61559ec910e6b4bb3f52b52e7ecaed6d3134c7fca7a18f96113cb21df770d08c"
    end

    on_arm do
      url "https://github.com/jinali98/zk-lense/releases/download/v0.1.2/zklense-aarch64-apple-darwin.tar.gz"
